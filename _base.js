/**
 * @deprecated
 * УСТАРЕВШИЙ МОДУЛЬ! Используйте database.js
 * 
 * Этот файл оставлен для обратной совместимости.
 * Новый код должен использовать модуль database.js
 * 
 * Причина deprecated:
 * - Каждый экземпляр создает свое подключение к БД
 * - Неэффективное использование connection pool
 * - Сложная логика переподключения
 * 
 * См. database.js для нового API
 */
